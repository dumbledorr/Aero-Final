...
function App({ initialMode }) {
    ...
    const handleSubmit = (e) => {
        ...
        let error = personalInfo.firstName === "" ||
    ...
    return (
        <Container className="mb-5 mt-2">
            <div className="App ml-10 mr-10" id="divToPrint">
                ...
                <Form onSubmit={handleSubmit} className={`${ templateType === 1 && (mode !== "edit" && mode !== "create") ? 'temp2-style':''}`}>
                    {
                    <div className={`${(pageNo === 0 || (mode !== "edit" && mode !== "create")) ? 'part-1':'hide'}`}>
                        <PersonalInfo
                            data={personalInfo}
