...
const PersonalInfo = ({ mode, data, onChange, templateType }) => {
    return (
        <Row className="mb-2" form>
            ...
            { !(mode === "edit" || mode === "create") && templateType === 0 &&
            ...
            {!(mode === "edit" || mode === "create") && templateType === 1 &&
                <div className="temp2-final-info">
                {data && data.image &&
                    <img alt="not found" className={`${templateType === 0 ? '':'rounded-image'}`} width={"190px"} src={URL.createObjectURL(data.image)} />
                }
                <div className="pl-35">
                    ...
                    <div className="description">
                        <div className="font-20">PERSONAL PROFILE</div>
                        {data.description}
                    </div>
                    <div className="contact-details">
                        <div className="font-20">CONTACT DETAILS</div>
                        <div className="address">
                            {data.address}
                        </div>
                        <div className="email">
